...
from docx import Document   # To convert MS Word's .docx contents to String.
...
class FileToLLMConverter:
    ...
    def docx_to_text(self, docx_path: str, file_type: str="ms-word") -> Tuple[str, Dict[str, Any]]:
        """Takes an absolute path to a .docx file and returns text representation"""
        self.logger.debug(f"Starting converting Microsoft Word File to string: {docx_path}")
        try:
